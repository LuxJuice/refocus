...
- Weather information
- Photos
- Household information and reminders

The Software runs locally on your personal hardware (Raspberry Pi or similar device).
...
- Maintaining the security of your device and local network
- Safeguarding your Google account credentials
- Ensuring your use complies with Google's Terms of Service
- Any content (photos, text) you add to your dashboard
...
We are not responsible for the availability, accuracy, or terms of third-party services.
...
- NON-INFRINGEMENT
- ACCURACY OR RELIABILITY OF DATA DISPLAYED

We do not warrant that:
- The Software will meet your requirements
- The Software will be uninterrupted or error-free
- Calendar, weather, or other data will be accurate
...
- Updates may be provided from time to time
- You may enable or disable automatic updates
- We are not obligated to provide updates, maintenance, or support
- Updates may modify features or functionality
...
We reserve the right to modify these Terms at any time. Changes will be reflected in the "Last Updated" date. Continued use after changes constitutes acceptance of the new Terms.
...
| Updates | Optional, may change features |
| Termination | Uninstall anytime, revoke Google access |
